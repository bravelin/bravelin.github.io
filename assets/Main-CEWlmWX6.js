...
ws://110.22.11.217:9102`)]),n("p",null,"wsplayer播放器调用播放方法需要上述两个地址。"),n("p",null,"页面引入wsplayer播放器的相关脚本文件："),n("pre",null,[n("code",null,`<script type="text/javascript" src="./js/WSPlayer/PlaySDKInterface.js"><\/script>
