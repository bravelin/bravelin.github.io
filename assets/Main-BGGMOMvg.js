...
3、向attribute变量传输数据；`)],-1)),t("canvas",B,null,512),n[22]||(n[22]=t("pre",null,[t("code",null,`const canvasRef = ref(null)
onMounted(() => {
...
gl.clearColor(0.0, 0.0, 0.0, 1.0)
gl.clear(gl.COLOR_BUFFER_BIT)`)],-1))])]),_:1})}const V=m(I,[["render",D]]);export{V as default};
