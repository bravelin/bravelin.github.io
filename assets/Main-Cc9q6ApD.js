import{_ as o,r,m as i,p as s,h as g,o as m,e as t}from"./index-CrCJ6E4y.js";const u={setup(){return{prefix:r("./imgs/gis/leaflet/")}}},p={class:"_article-content"},d={class:"common"},f={class:"pswp-img",href:"./imgs/gis/leaflet/02.png","data-pswp-width":"1351","data-pswp-height":"877",target:"_blank"},c=["src"];function x(l,n,y,a,L,A){const e=g("MyArticle");return m(),i(e,{class:"draw-clock-article",title:"与leaflet.js相关应用总结",date:"2022年12月10日"},{default:s(()=>[t("div",p,[n[0]||(n[0]=t("h3",{class:"title"},"使加载出错的tile图片不显示",-1)),n[1]||(n[1]=t("p",null,"添加以下样式，可使加载出错的tile不显示",-1)),n[2]||(n[2]=t("pre",null,[t("code",null,`.leaflet-tile-container img.leaflet-tile{
...
.leaflet-tile-container img.leaflet-tile.leaflet-tile-loaded {
    visibility: inherit;
    opacity: 1 !important;
}`)],-1)),n[3]||(n[3]=t("h3",{class:"title"},"添加天地图",-1)),n[4]||(n[4]=t("p",null,"相关配置：",-1)),n[5]||(n[5]=t("pre",null,[t("code",null,`const tiandituKey = '' // 天地图key
const config = {
    bg: {
...
map.addLayer(config.label.url, config.label.options)`)],-1)),n[6]||(n[6]=t("h3",{class:"title"},"通过浏览器Api获取用户当前经纬度信息：(https访问下才行)",-1)),n[7]||(n[7]=t("pre",null,[t("code",null,`function getCurrLocation () {
...
}`)],-1)),n[8]||(n[8]=t("h3",{class:"title"},"获取区域的中心点（质心）",-1)),n[9]||(n[9]=t("pre",null,[t("code",null,`export function computeArea (p0, p1, p2) {
    let area = 0.0
...
export function getRegionCenterPoint (latlngs, isArray = false, resArr = false) {
...
}`)],-1)),n[10]||(n[10]=t("h3",{class:"title"},"转换Polygon格式为latlngs",-1)),n[11]||(n[11]=t("pre",null,[t("code",null,`export function transformPolygonData (polygonData) {
    ...
    return []
}`)],-1)),n[12]||(n[12]=t("h3",{class:"title"},"GCJ02与WGS-84坐标系的互转",-1)),n[13]||(n[13]=t("pre",null,[t("code",null,`const PI = Math.PI
const a = 6378245.0
...
}`)],-1)),n[14]||(n[14]=t("h3",{class:"title"},"求出多边形的边界点",-1)),n[15]||(n[15]=t("pre",null,[t("code",null,`export function getRegionBoundsFromArr (latlngs) {
    let minLat = 999
    let minLng = 999
    let maxLat = 0
    let maxLng = 0
...
}`)],-1)),n[16]||(n[16]=t("h3",{class:"title"},"高亮显示区域",-1)),t("figure",d,[t("a",f,[t("img",{class:"thumbnail-img",src:a.prefix+"02.png"},null,8,c)])]),n[17]||(n[17]=t("p",null,"处理外层geojson数据，添加外层[[360, 90], [360, -90], [-360, -90], [-360, 90]]",-1)),n[18]||(n[18]=t("pre",null,[t("code",null,`export function handlerCoordinatesOfOuter (layerFeature) {
...
}`)],-1)),n[19]||(n[19]=t("pre",null,[t("code",null,`const contourDatas = geoJson.features[0]
...
outerLayer.addTo(map)`)],-1))])]),_:1})}const M=o(u,[["render",x]]);export{M as default};
