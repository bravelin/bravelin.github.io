import{_ as a,m as u,p as s,h as r,o,e as l,q as n}from"./index-DAung_sQ.js";const i={};function p(c,e){const t=r("MyArticle");return o(),u(t,{title:"Java学习笔记之三：继承",date:"2024年02月22日"},{default:s(()=>e[0]||(e[0]=[l("div",{class:"_article-content"},[l("p",null,'继承的基本思想是，可以基于已有的类创建新的类。继承已存在的类就是复用（继承）这些类的方法，而且可以增加一些新的方法和字段，使新类能够适应新的情况。"is-a"关系是继承的一个明显特征。'),l("p",null,"反射是指在程序运行期间更多地了解类及其属性的能力。"),l("pre",null,[l("code",null,`public class Manager extends Employee{
...
Object obj = cl.getConstructor().newInstance();`)])],-1)])),_:1})}const b=a(i,[["render",p]]);export{b as default};
