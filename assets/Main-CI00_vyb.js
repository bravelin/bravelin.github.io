import{_ as s,s as c,x as o,i as l,o as r,f as e}from"./index-Dav9PDu2.js";const a={};function i(u,n){const t=l("MyArticle");return r(),c(t,{title:"基于opencv4nodejs实现滑动拼图验证码的自动检测",date:"2025年04月20日"},{default:o(()=>n[0]||(n[0]=[e("div",{class:"_article-content"},[e("p",null,"opencv4已安装的前提下，nodejs作服务端利用@u4/opencv4nodejs模块实现检测功能；如果使用opencv4nodejs模块，则只支持opencv3版本。"),e("p",null,"终端执行以下命令："),e("pre",null,[e("code",null,`echo 'export OPENCV4NODEJS_DISABLE_AUTOBUILD=1' >> ~/.bashrc
