import{_ as t,s as o,x as r,h as i,o as s,f as e}from"./index-CxcENImR.js";const a={};function u(p,n){const l=i("MyArticle");return s(),o(l,{title:"Java学习笔记之七：集合(2)",date:"2024年03月17日"},{default:r(()=>[...n[0]||(n[0]=[e("div",{class:"_article-content"},[e("p",null,"通过使用视图可以得到其他实现了Collection接口或者Map接口的对象。"),e("p",null,"Java9引入了一些静态方法，可以生成给定元素的集或列表，以及给定键/值对的映射："),e("pre",null,[e("code",null,`List<String> names = List.of("Peter", "Paul", "Mary");
...
System.out.println("jdkVersion：" + jdkVersion); // jdkVersion：17`)]),e("h3",{class:"title"},"栈Stack"),e("pre",null,[e("code",null,`E push(E item); // 将item压入栈并返回item
E pop(); // 弹出栈顶元素并返回
E peek(); // 返回栈顶元素，但不弹出`)]),e("h3",{class:"title"},"位集BitSet"),e("p",null,"BitSet类会存储一个位序列。由于位集将位包装在字节里，因此使用位集要比使用Boolean对象的ArrayList高效得多。"),e("p",null,"BitSet类提供了一个用于读取、设置或重置各个位的很方便的接口。使用这个接口可以避免掩码和其他调整位的操作。"),e("pre",null,[e("code",null,`bucketOfBits.get(i); // 如果第i位处于"开"状态，就返回true；否则返回false
bucketOfBits.set(i); // 第i位设置为"开"状态
bucketOfBits.clear(i); // 第i位设置为"关"状态
            `)]),e("p",null,"统计质数："),e("pre",null,[e("code",null,`long start = System.currentTimeMillis();
int num = 2000000;
...
System.out.println("质数总计：" + count);`)])],-1)])]),_:1})}const d=t(a,[["render",u]]);export{d as default};
