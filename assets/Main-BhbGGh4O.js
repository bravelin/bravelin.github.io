import{_ as n,s as r,x as a,i as o,o as i,f as l}from"./index-Dav9PDu2.js";const s={};function u(p,e){const t=o("MyArticle");return i(),r(t,{title:"Java学习笔记之九：流",date:"2024年03月29日"},{default:a(()=>e[0]||(e[0]=[l("div",{class:"_article-content"},[l("p",null,"与集合相比，流提供了一种在更高的概念级别上指定计算任务的数据视图，通过使用流，可以指明想要完成什么任务，而不是指明如何去实现它。用来以“做什么而非怎么做”的方式处理集合。"),l("pre",null,[l("code",null,`//统计单词计数
int count = 0;
