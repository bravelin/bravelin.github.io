import{_ as r,s as a,x as i,i as t,o as c,f as n}from"./index-Dav9PDu2.js";const u={};function s(p,l){const e=t("MyArticle");return c(),a(e,{title:"Java学习笔记之六：泛型程序设计",date:"2024年03月10日"},{default:i(()=>l[0]||(l[0]=[n("div",{class:"_article-content"},[n("p",null,"泛型程序设计（generic programming）意味着编写的代码可以对多种不同类型的对象重用。类型参数会让你的程序更易读，也更安全。"),n("p",null,"泛型类是有一个或多个类型变量的类："),n("pre",null,[n("code",null,`public class Pair<T>{
    private T first;
}
