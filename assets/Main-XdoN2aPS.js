...
y' = b * x + d * y + f`)],-1)),t[60]||(t[60]=n("h3",{class:"title"},"剪辑区域",-1)),t[61]||(t[61]=n("p",null,"由路径定义的一块区域，浏览器会将所有的绘图操作都限制在本区域内。默认情况下剪辑区域就是整个Canvas，除非创建路径并调用clip()方法显式地设置剪辑区域。",-1)),t[62]||(t[62]=n("p",null,"利用剪辑区域实现的伸缩式动画：",-1)),n("div",q,[n("canvas",j,null,512)]),t[63]||(t[63]=n("pre",null,[n("code",null,`drawClipAni () {
    let that = this
