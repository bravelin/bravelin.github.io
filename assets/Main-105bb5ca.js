import{u as N}from"./highlight-2e3cec98.js";import{_ as M,j as A,b as W,c as q,e as c,p as B,l as L}from"./index-4afbb925.js";let v=null;const E={setup(){N()},data(){return{currRotateDeg:0,needRotateDeg:0,needRotateDuration:5,inRotating:!1,winningPrize:null,prizes:[{name:"移动电源",deg:0},{name:"¥100元现金券",deg:0},{name:"谢谢惠顾",deg:0},{name:"iphone 6s",deg:0},{name:"签字笔",deg:0},{name:"再来一次",deg:0}]}},mounted(){this.drawWheel(),v=A()},methods:{drawWheel(){const n=this,r=Math.PI,e=n.$refs.wheel.getContext("2d");e.strokeStyle="#ffb534",e.lineWidth=8,e.arc(331,331,323,0,2*r),e.stroke(),e.beginPath(),e.strokeStyle="#de910d",e.fillStyle="#f8d300",e.lineWidth=1,e.arc(331,331,319,0,2*r),e.stroke(),e.fill(),e.beginPath(),e.strokeStyle="#d28500",e.lineWidth=11,e.arc(331,331,289,0,2*r),e.stroke();const h=6,a=8,p=307;let s=360/18*(r/180),l=r/2;e.fillStyle="#fff";for(let _=0;_<9;_++)e.beginPath(),e.arc(331+Math.cos(l)*p,331+Math.sin(l)*p,h,0,2*r),e.fill(),l+=s,e.beginPath(),e.arc(331+Math.cos(l)*p,331+Math.sin(l)*p,a,0,2*r),e.fill(),l+=s;const u=n.prizes,k=[{color:"#b92401",bgColor:"#fff6e5"},{color:"#590202",bgColor:"#ffd488"},{color:"#b92401",bgColor:"#fee0d5"}];s=360/u.length*(r/180);const S=360/u.length,x=283;l=r/2;let P=90,R;e.font="bold 44px 微软雅黑";const D=2*r*x*.58/u.length;e.textAlign="center",e.textBaseline="middle";let d,z,b,T,C,o,f=0;for(f=0;f<u.length;f++)o=u[f],e.beginPath(),e.moveTo(331,331),e.arc(331,331,x,l,l+s),e.lineTo(331,331),R=k[f%3],e.fillStyle=R.bgColor,e.fill(),e.closePath(),o.deg=P+S/2,o.deg>360&&(o.deg=o.deg-360),o.deg<270?o.deg=270-o.deg:o.deg=360-(o.deg-270),e.fillStyle=R.color,e.save(),e.translate(331,331),e.rotate(l+s/2+r/2),d=u[f].name,e.measureText(d).width>D?(C=d.split(" "),C.length==2?(z=C[0],b=C[1]):(T=n.getTextSplitPos(d,e,D),z=d.substr(0,T),b=d.substr(T)),e.fillText(z,0,-x*.72,D),e.fillText(b,0,-x*.52,D)):e.fillText(d,0,-x*.65),e.restore(),l+=s,P+=S;const t=n.$refs.pointer.getContext("2d");t.fillStyle="#ffa406";const i=79,g=210-i;t.arc(i,g,i,0,2*r),t.fill(),t.beginPath();const w=80,y=64;t.fillStyle="#eb1244",t.moveTo(i,0),t.lineTo(i-y/2,w),t.lineTo(i,w),t.lineTo(i,0),t.closePath(),t.fill(),t.fillStyle="#b9072f",t.beginPath(),t.moveTo(i,0),t.lineTo(i+y/2,w),t.lineTo(i,w),t.lineTo(i,0),t.closePath(),t.fill(),t.beginPath(),t.fillStyle="#fa5f75",t.arc(i,g,i-15,0,2*r),t.closePath(),t.fill(),t.beginPath();const m=t.createRadialGradient(i,g,0,i,g,i-25);m.addColorStop(0,"#f5385f"),m.addColorStop(.75,"#f5385f"),m.addColorStop(.82,"#eb1244"),m.addColorStop(1,"#eb1244"),t.fillStyle=m,t.arc(i,g,i-25,0,2*r),t.closePath(),t.fill(),t.font="bold 36px 微软雅黑",t.textAlign="center",t.textBaseline="middle",t.fillStyle="#fff",t.fillText("点击",i,g-24),t.fillText("抽奖",i,g+16)},getTextSplitPos(n,r,e){if(n.length<=3)return n.length;if(/^[\u4E00-\u9FFF]+$/.test(n))return Math.ceil(n.length/2);{let h=n.substr(0,3);for(let a=3;a<n.length;a++)if(h=h+n.charAt(a),r.measureText(h).width>e)return a+1}return n.length},doClickLotteryBtn(){const n=this;if(n.inRotating)return v.info("抽奖中...");const r=n.prizes;n.winningPrize=r[parseInt(Math.random()*r.length)],n.inRotating=!0;const e=360*3+n.winningPrize.deg-n.currRotateDeg%360;n.needRotateDuration=.75*(e/180),n.needRotateDeg=n.currRotateDeg+e,n.currRotateDeg=n.needRotateDeg},doHandlerRotateEnd(){const n=this;n.inRotating&&(n.inRotating=!1,v.success("您抽中了："+n.winningPrize.name))}}},F={class:"article-container spin-draw-article"},$=c("h2",{class:"article-title"},"一个转盘抽奖的前端实现例子",-1),H={class:"article-content"},I=c("p",null,"转盘抽奖一般用于吸引用户，提升活跃度。上周应产品需求，实现了这个功能。下面的转盘使用随机数模拟中奖结果（可尝试点击）：",-1),V={class:"exp"},j=L(`<p>个人觉得实现的难点有三：一是如何根据奖品的数目绘制转盘背景；二是如何将不同长度的奖品文字绘制在扇区上面，并旋转相应的角度；三是如何计算出中奖之后转盘应该旋转的角度。</p><p>如果这三点实现了的话，再加上用户可抽奖次数控制逻辑、中奖之后奖品的弹窗显示等功能基本上就完成了。</p><p>定义奖品的数据结构：</p><pre><code>prizes: [
...
that.needRotateDuration = 0.75 * (deltDeg / 180)</code></pre><p>上面设定的旋转速率是0.75s/180deg，将上面两个值设定到转盘transform中的rotate和transition-duration中就可以了。(vue中的写法)</p><pre><code>:style=&quot;{ transform: &#39;rotate(&#39;+ needRotateDeg +&#39;deg)&#39;, &#39;transition-duration&#39; : needRotateDuration+&#39;s&#39;}&quot;</code></pre><p>关于如何在旋转完之后弹出显示中奖结果，可以监听转盘的transitionend事件。(vue中的写法)</p><pre><code>@transitionend=&quot;doHandlerRotateEnd()&quot;</code></pre>`,26),G=c("footer",null,"2016年12月07日",-1);function J(n,r,e,h,a,p){return W(),q("div",F,[$,c("div",H,[I,c("div",V,[c("canvas",{ref:"wheel",width:"662",height:"662",style:B({transform:"rotate("+a.needRotateDeg+"deg)","transition-duration":a.needRotateDuration+"s"}),onTransitionend:r[0]||(r[0]=s=>p.doHandlerRotateEnd())},null,36),c("canvas",{ref:"pointer",width:"158",height:"210",onClick:r[1]||(r[1]=s=>p.doClickLotteryBtn())},null,512)]),j]),G])}const Q=M(E,[["render",J]]);export{Q as default};
