...
var v2 = dv.getUint16(1) // 从第1个字节读取一个uint16`)]),n("p",null,"如果一次读取两个或者两个以上的字节，则必须明确数据的储存方式，是小端序列还是大端序列（默认），如果是小端序列，第2个参数需要设定为true："),n("pre",null,[n("code",null,"var v3 = dv.getUint8(4, true)")]),n("p",null,[l("DataView提供以下8个方法写入内存： "),n("strong",null,"setUint8、setInt8、setUint16、setInt16、setInt32、setUint32、setFloat32、setFloat64"),l("，接受3个参数，第1个参数表示写入的位置，第2个参数是写入的数据，第3个参数表面数据的储存方式（大小端）：")]),n("pre",null,[n("code",null,"dv.setUint32(0, 32, true)")])],-1)])),_:1})}const b=t(p,[["render",f]]);export{b as default};
