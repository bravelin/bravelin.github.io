...
}`)],-1)),t[4]||(t[4]=s("h3",{class:"title"},"抛物线运动",-1)),s("div",x,[s("canvas",M,null,512)]),t[5]||(t[5]=s("pre",null,[s("code",null,`const move = {
    execute (sprite, context, time) {
...
}`)],-1)),t[6]||(t[6]=s("h3",{class:"title"},"钟摆运动",-1)),s("div",C,[s("canvas",R,null,512)]),t[7]||(t[7]=s("p",null,"定义精灵对象：",-1)),t[8]||(t[8]=s("pre",null,[s("code",null,`const initAngle = Math.PI / 7
that.pendulum = new Sprite({
    ...
    lastTime: (+new Date()),
    elapseTime: 0
})`)],-1)),t[9]||(t[9]=s("p",null,"绘制器对象：",-1)),t[10]||(t[10]=s("pre",null,[s("code",null,`const pendulumPainter = {
...
}`)],-1)),t[11]||(t[11]=s("p",null,"行为对象：",-1)),t[12]||(t[12]=s("pre",null,[s("code",null,`const move = {
    execute (sprite, context, time) {
        time = time || (+new Date())
