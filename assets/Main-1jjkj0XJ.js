...
3、向attribute变量传输数据；`)],-1)),t("canvas",h,null,512),n[22]||(n[22]=t("pre",null,[t("code",null,`const canvasRef = ref(null)
onMounted(() => {
