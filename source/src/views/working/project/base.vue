<template>
    <div class="page article">
        ...
        <div class="content article">
            ...
            <figure>
                <img style="max-width: 832px;" src="../../../assets/work/base/1.png"/>
            </figure>
            ...
            <figure>
                <img style="max-width: 831px;" src="../../../assets/work/base/3.png"/>
            </figure>
            ...
            <p>执行以下命令：</p>
            <pre><code>$ gem sources --add https://gems.ruby-china.org/ --remove https://rubygems.org/</code></pre>
            <p>如果失败则将https改为http：</p>
            <pre><code>$ gem sources --add http://gems.ruby-china.org/ --remove https://rubygems.org/</code></pre>
            <p>gem source -l 命令查看配置是否生效：</p>
            <figure>
                <img style="max-width: 644px;" src="../../../assets/work/base/5.png"/>
            </figure>
            <p>更新gem（非必须）：gem update --system</p>
            <figure>
                <img style="max-width: 644px;" src="../../../assets/work/base/6.png"/>
            </figure>
            <p><strong>2. 安装sass</strong></p>
            <p>在ruby命令行窗口执行：gem install sass</p>
            <figure>
                <img style="max-width: 644px;" src="../../../assets/work/base/7.png"/>
            </figure>
            <p>命令 sass -v 可以查看sass的版本：</p>
            <figure>
                <img style="max-width: 644px;" src="../../../assets/work/base/8.png"/>
            </figure>
    ...
    $ npm config set cache 'C:\Program Files\nodejs\node_cache'</code></pre>
            ...
            <figure>
                <img style="max-width: 800px;" src="../../../assets/work/base/11.png"/>
            </figure>
            <figure>
                <img style="max-width: 800px;" src="../../../assets/work/base/12.png"/>
            </figure>
            <p>新增环境变量：NODE_PATH</p>
            <p>值：C:\Program Files\nodejs\node_global\node_modules</p>
            <p>在命令行窗口上执行以下命令，全局安装gulp</p>
            <pre><code>cnpm install gulp –g</code></pre>
            ...
            <figure>
                <img style="max-width: 800px;" src="../../../assets/work/base/13.png"/>
            </figure>
            <p>然而这种方式会导致积累很多文件，期望的替换方式是这样的：</p>
            <figure>
                <img style="max-width: 800px;" src="../../../assets/work/base/14.png"/>
            </figure>
