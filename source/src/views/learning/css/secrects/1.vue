<template>
    <div class="page article">
        ...
        <div class="content">
            ...
            <p>
                这并不是一本厚厚的权威指南，并不适合初学者，它的目标读者是正在由中级向高级进阶的CSS开发者。作者在书中揭示了47个鲜为人知的CSS技巧，为前端开发遇到的各种网页难题，探寻出了更优雅的解决方案。主要包括7大主题：</p>
  ...
  background: linear-gradient(90deg, yellow, red); // 标准语法</code></pre>
    ...
    return false
            ...
            <button @click="testValue('linear-gradient(red,tan)','backgroundImage')">检测浏览器是否支持linear-gradient(red,tan)
            </button>
...
<script>
    ...
    module.exports = {
        mounted: function () {
            ...
            Global.setArticleNavMenu('learning-css-secrects-1')
        },
        methods: {
