<template>
    <div class="page article">
        ...
        <div class="content">
            ...
            <div class="exp auto-width">
                <figure><img src="/static/assets/header.jpg"/>
                    <figcaption>这是一张图片的说明文字。图片底部的文字自动换行了。</figcaption>
                </figure>
            </div>
            <pre><code>figure{
  ...
  margin: 0 auto;
            ...
            <p>表格的列宽通常都是根据内容进行调整的，即使显示地指定了width。CSS2.1有一个属性称之为：<strong>table-layout</strong>，默认值为auto，此时浏览器会使用自动表格布局算法调整表格的布局。如果设置为另外的一个值：fixed，则可以对表格更多控制。
            </p>
