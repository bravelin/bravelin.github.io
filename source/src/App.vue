    ...
    <div @click="doHideSideMenu()">
        ...
        <div class="note-wrap modal" ref="noteWrap">
            <div>
                ...
                <div class="content">
                    <div class="clear-fix" v-show="!isReply"><label>您的称呼：</label><input ref='noteNameEl'
                                                                                        v-model="noteName" type="text"
                                                                                        placeholder="your name"
                                                                                        maxlength="20"/></div>
                    <div class="clear-fix"><label>{{ isReply ? "回复的话" : "您想说的话" }}：</label><textarea ref='noteContentEl'
                                                                                                     v-model="noteContent"
